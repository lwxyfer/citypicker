...
/***/ function(module, exports, __webpack_require__) {
	...
	var _citydate = __webpack_require__(1);
	...
	function picker() {
		...
		// load province data
		for (var provinces in _citydate.ChineseDistricts[86]) {
			if (provinces && _citydate.ChineseDistricts[86][provinces]) {
				province += '<option value=' + provinces + '>' + _citydate.ChineseDistricts[86][provinces] + '</option>';
			}
		}
		...
		function render(event) {
			...
			if (target.nodeName.toUpperCase() === 'SELECT') {
				if (name === 'province') {
					...
					provinceCode = (0, _loop.loop)(target, districtNode, district);
					dataSelected.province = _citydate.ChineseDistricts[86][provinceCode];
				}
				if (name === 'district') {
					distinctCode = (0, _loop.loop)(target, areaNode, area);
					dataSelected.district = _citydate.ChineseDistricts[provinceCode][distinctCode];
				}
				if (name === 'area') {
					areaCode = target.options[target.selectedIndex].value;
					dataSelected.area = _citydate.ChineseDistricts[distinctCode][areaCode];
				}
...
/***/ function(module, exports) {
	 ...
	 * city date
	 */
	var ChineseDistricts = exports.ChineseDistricts = {
	  86: {
	    110000: '北京市',
	    120000: '天津市',
	    130000: '河北省',
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @return  [postcode]
	 */
	function loop(selectTarget, node, data) {
	  var index = selectTarget.selectedIndex;
	  var value = selectTarget.options[index].value;
	  for (var items in _citydate.ChineseDistricts[value]) {
	    if (items && _citydate.ChineseDistricts[value][items]) {
	      data += '<option value=' + items + '>' + _citydate.ChineseDistricts[value][items] + '</option>';
	    }
	  }
	  node.innerHTML = data;
	  return value;
